...
abstract class Radio_i_pradio_radio_TestApi extends BridgeTestSuite[Radio_i_pradio_radio_Bridge](Arch.s_impl_Instance_pradio_radio) {

  /** helper function to check Radio_i_pradio_radio's
