...
t_AttestationGate_Filter_Impl_Filter_Filter_Bridge_EntryPoints entryPoints;
...
void init(STACK_FRAME_ONLY) {
  if(!initialized) {
    ...
    entryPoints = (t_AttestationGate_Filter_Impl_Filter_Filter_Bridge_EntryPoints) t_AttestationGate_Filter_Impl_Filter_Filter_adapter_entryPoints(SF_LAST);
    event_in_port_ids = (IS_82ABD8) t_AttestationGate_Filter_Impl_Filter_Filter_Bridge_EntryPoints_eventInPortIds_(entryPoints);
    data_in_port_ids = (IS_82ABD8) t_AttestationGate_Filter_Impl_Filter_Filter_Bridge_EntryPoints_dataInPortIds_(entryPoints);
    event_out_port_ids = (IS_82ABD8) t_AttestationGate_Filter_Impl_Filter_Filter_Bridge_EntryPoints_eventOutPortIds_(entryPoints);
    data_out_port_ids = (IS_82ABD8) t_AttestationGate_Filter_Impl_Filter_Filter_Bridge_EntryPoints_dataOutPortIds_(entryPoints);
    initialized = true;
  }
}
...
void checkAndReportBufferOverrun(STACK_FRAME long bytesWritten, long bufferSizeBytes) {
  ...
  if (bytesWritten > bufferSizeBytes) {
    ...
    api_logInfo__t_AttestationGate_Filter_Impl_Filter_Filter(SF str);
  }
  #endif
}
...
void ffiapi_logDebug(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes){
  ...
  api_logDebug__t_AttestationGate_Filter_Impl_Filter_Filter(SF str);
} 
...
void ffiapi_logError(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes){
  ...
  api_logError__t_AttestationGate_Filter_Impl_Filter_Filter(SF str);
} 
...
void ffiapi_get_Input(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  size_t numBits = 0;
  output[0] = api_get_Input__t_AttestationGate_Filter_Impl_Filter_Filter(SF &numBits, (U8 *)(output + 1));
...
void ffiapi_send_Output(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  api_put_Output__t_AttestationGate_Filter_Impl_Filter_Filter(SF parameterSizeBytes*8, (U8 *)parameter);
}
